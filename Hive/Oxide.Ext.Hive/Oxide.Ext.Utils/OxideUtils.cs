...
namespace Oxide.Ext.Hive.Utils {
	public class OxideUtils {
		...
		public static Dictionary<String, String> combine(Dictionary<String, String> baseDic, Dictionary<String, String> addDic) {
			if(addDic != null) {
				addDic.ToList().ForEach(x => baseDic.Add(x.Key, x.Value));
			}
			return baseDic;
		}
